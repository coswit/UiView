...
/**
 * @author Created by zhengjing on 2019-12-02.
 */
public class ScrollTextView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mTop = getTop();
        mBottom = getBottom();
        canvas.drawText(String.format("(%1$d , %2$d)", mLeft, mTop), 0 , 50, mPaint);
        canvas.drawText(String.format("(%1$d , %2$d)", mRight, mBottom), 20 , 170, mPaint);
    }
