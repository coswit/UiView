...
public class StickyNavLayout2 extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mNav = findViewById(R.id.slidingtablayout);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mInnerScrollView instanceof ScrollView) {
                    ...
                    if (!isInControl && rv.canScrollVertically(-1) && isTopHidden
                            && dy > 0) {
                        isInControl = true;
                        ev.setAction(MotionEvent.ACTION_CANCEL);
                        MotionEvent ev2 = MotionEvent.obtain(ev);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        if (!isTopHidden || (!ViewCompat.canScrollVertically(webView, -1) && isTopHidden && dy > 0)) {
                            initVelocityTrackerIfNotExists();
                            mVelocityTracker.addMovement(ev);
                            mLastY = y;
                            return true;
