...
/**
 * @author Created by zhengjing on 2020/9/14.
 */
public class SlidingTabView extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void initAttr() {
        mIndicatorColor = 0xFF2196F3;
        mIndicatorCornerRadius = dp2px(5);
        mIndicatorHeight = dp2px(4);
        mIndicatorWidth = dp2px(12);
        mIndicatorWidthEqualTitle = true;
        mTabPadding = dp2px(2);
        mTextBold = TEXT_BOLD_WHEN_SELECT;
        mTextSelectColor = 0xFF2A2A2A;
        mTextUnselectColor = 0xFF666666;
        mTextsize = sp2px(15);
        mTabSpaceEqual = true;
        mIndicatorGravity = Gravity.BOTTOM;
        mIndicatorMarginBottom = dp2px(1);
    }
