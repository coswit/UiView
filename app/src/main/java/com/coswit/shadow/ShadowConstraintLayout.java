...
/**
 * @author Created by zhengjing on 2020/10/16.
 */
...
//        Bitmap bitmap = createShadowBitmap(w, h, mCornerRadius, mShadowRadius, mDx, mDy, mShadowColor, Color.TRANSPARENT);
        Bitmap bitmap = createShadowBitmap(w, h, mCornerRadius, mShadowRadius, mDx, mDy, 0xFF000000,0xFFFFFFFF);
...
//        shadowPaint.setColor(fillColor);
        shadowPaint.setColor(0x10F8F8F8);
        shadowPaint.setStyle(Paint.Style.STROKE);

        if (!isInEditMode()) {
//            shadowPaint.setShadowLayer(shadowRadius, dx, dy, shadowColor);
            shadowPaint.setStyle(Paint.Style.FILL);
            shadowPaint.setShadowLayer(shadowRadius, dx, dy, 0xFFF8F8F8);
        }
        shadowPaint.setStyle(Paint.Style.STROKE);
